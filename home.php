  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post">
            <input type="text" class="form-group" id="search" placeholder=" Enter name ..." autocomplete="off" style="width:200px;height:30px;border:none;" required>
        </form>
...
<div class="navbar">
            ...
            <div class="icon pull-right">
                <a class="btn btn-default" href="functions/logout.php" role="button" style="border-radius: 0px;"> Logout </a>
            </div>
        </div>
        <div class="menu">
            <center>
