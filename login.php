...
<html>
    ...
    <center>
            ...
            <div class="form">
                ...
                <input type="submit" value="Login" class="btn btn-info" style="padding-left:20px;padding-right:20px;"><br><br>
                <p><a href="signup.php" class="text-info small">Don,t have an acount ? Sign Up</a></p>
            </div>
            </form>
        </center>
        <div class="navbar">
            <h1 class="pull-left">| Login Validation</h1>
